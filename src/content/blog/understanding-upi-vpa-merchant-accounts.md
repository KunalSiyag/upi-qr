...
* **Bank Handle:** The banking provider processing the transactions (e.g., `@okaxis`, `@ybl`, `@okhdfcbank`).
...
1. Download a merchant app like **PhonePe Business**, **Google Pay for Business**, or **Paytm for Business**.
2. Sign up with your mobile number and link your business bank account.
3. Enter your business details (GSTIN if applicable, shop category, address).
4. The app will instantly generate a verified business VPA (e.g., `merch.shopname@okaxis`).
5. Use this new business VPA on the [Pro UPI QR Generator](https://www.proupiqr.in) to create a professional table standee card.
...
**[Generate your merchant payment QR standee today &rarr;](https://www.proupiqr.in)**
