...
export const HOME_COPY: Record<Exclude<SiteLang, "en" | "hi">, HomeCopy> = {
  ...
  ar: {
    title: "مولّد رموز QR مجاني | Pro UPI QR",
    description: "أنشئ رموز QR للدفع والروابط والفواتير بدون تسجيل. نزّل ملصقات عالية الدقة لمتجرك.",
    eyebrow: "مولّد رموز QR (العربية)",
    h1: "رموز QR وفواتير لمتجرك",
    intro: "أنشئ رمز دفع أو فاتورة PDF في ثوانٍ. المعالجة تتم في متصفحك وبياناتك تبقى خاصة.",
    ctaGenerate: "إنشاء رمز QR",
    ctaTemplates: "قوالب الملصقات",
    presetsLabel: "أدوات سريعة",
    generatorEyebrow: "المولّد",
    generatorH2: "رمز QR عالي الدقة خلال 30 ثانية",
    generatorIntro: "متوافق مع كاميرات الهواتف وتطبيقات الدفع التي تقرأ الرموز القياسية.",
    privacy: "الخصوصية: المعالجة محلية 100% في المتصفح. لا تُرسل بياناتك إلى خوادمنا.",
    faqHeading: "الأسئلة الشائعة",
    features: [
      { title: "إنشاء فوري", copy: "بدون حساب أو لوحة تحكم. أنشئ ونزّل مباشرة." },
      { title: "جودة طباعة عالية", copy: "رموز واضحة للطباعة بأي مقاس." },
      { title: "ملصقات للكاونتر", copy: "تنسيقات جاهزة للطاولات والواجهات." },
    ],
    useCases: ["المتاجر", "المستقلون", "المطاعم", "الخدمات", "الفعاليات", "التبرعات"],
    faqs: [
      { question: "كيف أنشئ رمز QR؟", answer: "أدخل بياناتك واضغط إنشاء ثم نزّل الصورة." },
      { question: "هل يعمل على كل الهواتف؟", answer: "نعم، معيار عالمي لكاميرات iOS وAndroid." },
      { question: "هل توجد علامة مائية؟", answer: "مجاني بالكامل وبدون علامة مائية." },
    ],
  },
  it: {
    title: "Generatore di QR Code Gratis | Pro UPI QR",
    description: "Crea QR code per pagamenti, link e fatture senza registrazione. Scarica poster ad alta risoluzione per il tuo negozio.",
    eyebrow: "Generatore QR (Italiano)",
    h1: "QR Code e fatture per la tua attività",
    intro: "Crea un QR di pagamento o una fattura PDF in pochi secondi. Tutto resta privato nel browser.",
    ctaGenerate: "Crea QR code",
    ctaTemplates: "Modelli di poster",
    presetsLabel: "Strumenti rapidi",
    generatorEyebrow: "Generatore",
    generatorH2: "QR ad alta risoluzione in 30 secondi",
    generatorIntro: "Compatibile con fotocamere e app di scansione standard.",
    privacy: "Privacy: elaborazione 100% locale nel browser. Nessun dato sui nostri server.",
    faqHeading: "Domande frequenti",
    features: [
      { title: "Creazione istantanea", copy: "Niente account. Crea e scarica subito." },
      { title: "Qualità di stampa", copy: "QR nitidi per qualsiasi formato." },
      { title: "Supporti da banco", copy: "Layout pronti per banconi e tavoli." },
    ],
    useCases: ["Negozi", "Freelance", "Ristoranti", "Servizi", "Eventi", "Donazioni"],
    faqs: [
      { question: "Come creo un QR code?", answer: "Inserisci i dati, premi Genera e scarica l'immagine." },
      { question: "Funziona su ogni smartphone?", answer: "Sì, standard universale per iOS e Android." },
      { question: "C'è una filigrana?", answer: "No, è gratis e senza watermark." },
    ],
  },
  ja: {
    title: "無料QRコードジェネレーター | Pro UPI QR",
    description: "登録なしで支払い・リンク・請求書のQRコードを作成。高解像度ポスターをダウンロード。",
    eyebrow: "QRコード作成（日本語）",
    h1: "店舗向けQRコードと請求書",
    intro: "支払いQRやPDF請求書を数秒で作成。処理はブラウザ内で完結し、データは外部に送られません。",
    ctaGenerate: "QRを作成",
    ctaTemplates: "ポスターテンプレート",
    presetsLabel: "クイックツール",
    generatorEyebrow: "ジェネレーター",
    generatorH2: "30秒で高解像度QR",
    generatorIntro: "スマホのカメラと標準的な読み取りアプリに対応。",
    privacy: "プライバシー: 処理はブラウザ内のみ。サーバーに保存しません。",
    faqHeading: "よくある質問",
    features: [
      { title: "すぐ作れる", copy: "ログイン不要。その場で作成・ダウンロード。" },
      { title: "印刷に強い", copy: "どのサイズでも読みやすいQR。" },
      { title: "カウンター用", copy: "卓上・店頭用のレイアウト済み。" },
    ],
    useCases: ["店舗", "フリーランス", "飲食店", "サービス業", "イベント", "寄付"],
    faqs: [
      { question: "QRの作り方は？", answer: "情報を入力して作成を押し、画像を保存します。" },
      { question: "どのスマホでも読めますか？", answer: "はい。iOS / Android のカメラで読めます。" },
      { question: "透かしはありますか？", answer: "ありません。無料で透かしなしです。" },
    ],
  },
  zh: {
    title: "免费二维码生成器 | Pro UPI QR",
    description: "无需注册即可生成收款、链接和发票二维码。下载高清海报用于店铺展示。",
    eyebrow: "二维码生成器（中文）",
    h1: "店铺收款码与发票工具",
    intro: "几秒内生成收款二维码或 PDF 发票。全部在浏览器本地完成，数据不会上传。",
    ctaGenerate: "生成二维码",
    ctaTemplates: "海报模板",
    presetsLabel: "快捷工具",
    generatorEyebrow: "生成器",
    generatorH2: "30 秒生成高清二维码",
    generatorIntro: "兼容手机相机和标准扫码应用。",
    privacy: "隐私：100% 在浏览器本地处理，不会发送到我们的服务器。",
    faqHeading: "常见问题",
    features: [
      { title: "即时生成", copy: "无需登录。当场创建并下载。" },
      { title: "印刷清晰", copy: "任意尺寸都可扫描。" },
      { title: "柜台物料", copy: "桌贴、立牌等现成版式。" },
    ],
    useCases: ["零售店", "自由职业", "餐饮", "服务行业", "活动", "捐赠"],
    faqs: [
      { question: "如何生成二维码？", answer: "填写信息，点击生成，然后下载图片。" },
      { question: "所有手机都能扫吗？", answer: "可以，iOS 和 Android 相机均可。" },
      { question: "有水印吗？", answer: "没有。完全免费且无水印。" },
    ],
  },
};
