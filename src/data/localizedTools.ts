...
export const LOCALIZED_TOOLS: LocalizedTool[] = [
  ...
  tool("upi-mdr-calculator", "UPI MDR Calculator", "upiMdr", {
    hi: {
      ...
      steps: ["बिल राशि डालें", "दुकान / जरूरी सेवा / P2P चुनें", "छोटे मर्चेंट छूट तभी टिक करें जब बैंक ने P2PM टैग किया हो"],
      faqs: [
  ...
  tool("upi-qr-decoder", "UPI QR Decoder", "decoder", {
    hi: {
      name: "UPI QR वैलिडेटर और डिकोडर",
      title: "UPI QR सुरक्षा जांच और VPA डिकोडर | मुफ्त",
      description: "UPI QR इमेज से VPA, नाम और राशि निकालें और सुरक्षा रिपोर्ट पाएं। प्रिंट या स्कैन से पहले जांचें।",
      intro: "हर QR को लगाने से पहले सुरक्षा जांचें। टूल VPA, राशि, और संदिग्ध फील्ड दिखाता है।",
      steps: ["QR इमेज अपलोड करें", "सुरक्षा रिपोर्ट पढ़ें", "सही हो तो प्रिंट करें"],
      faqs: [
        { question: "क्या डेटा सर्वर पर जाता है?", answer: "नहीं। सब ब्राउज़र में होता है। इमेज कहीं नहीं भेजी जाती।" },
        { question: "रेड वॉर्निंग मिली तो क्या करें?", answer: "उस QR को न लगाएं। VPA क्रॉस-चेक करें और Create Standee से नया QR बनाएं।" }
      ]
    },
    ta: {
      name: "UPI QR டிகோடர்",
  ...
  tool("merchant-reconciliation", "UPI Reconciliation Tool", "merchantRecon", {
    hi: {
      name: "UPI मिलान टूल",
      title: "UPI मिलान टूल — इनवॉइस और UTR मिलाएं | मुफ्त",
      description: "अपनी सेल्स CSV अपलोड करें, UPI रकम डालें और तुरंत अंतर देखें। PDF/CVS एक्सपोर्ट के साथ 100% ब्राउज़र में।",
      intro: "हर महीने की सूची चेक करें — किस ग्राहक ने कम भुगतान किया या कौन-सा भुगतान बाकी है।",
      steps: ["CSV अपलोड करें (Date, Invoice, Amount)", "हर एंट्री पर UPI received रकम डालें", "PDF/CVS एक्सपोर्ट करें"],
      faqs: [
        { question: "डेटा सर्वर पर जाता है?", answer: "नहीं। सब ब्राउज़र में localStorage में रहता है। कुछ भी अपलोड नहीं होता।" },
        { question: "कौन-सा CSV फॉर्मेट चाहिए?", answer: "Date, Invoice और Amount तीन कॉलम ज़रूरी हैं। Customer कॉलम ऑप्शनल है।" }
      ]
    },
    ta: {
      name: "UPI சமநிலை கருவி",
      title: "UPI சமநிலை கருவி — Invoice & UTR | இலவசம்",
      description: "Sales CSV பதிவேற்றவும், UPI தொகையை உள்ளிடவும், வித்தியாசத்தை உடனே பார்க்கவும். PDF/CSV ஏற்றுமதி.",
      intro: "ஒவ்வொரு மாதமும் யார் குறைவாக செலுத்தினார்கள், யார் முழுமையாக செலுத்தினார்கள் என சரிபார்க்கவும்.",
      steps: ["CSV பதிவேற்றவும்", "ஒவ்வொரு வரிசைக்கும் UPI தொகை சேர்க்கவும்", "PDF/CSV ஏற்றுமதி"],
      faqs: [{ question: "தரவு சர்வருக்கு அனுப்பப்படுமா?", answer: "இல்லை. எல்லாம் உலாவியிலேயே இருக்கும்." }]
    },
    te: {
      name: "UPI సరిపోలిక సాధనం",
      title: "UPI సరిపోలిక — Invoice & UTR | ఉచితం",
      description: "Sales CSV ని అప్‌లోడ్ చేయండి, UPI మొత్తాన్ని నమోదు చేయండి, తేడా తక్షణమే చూడండి. PDF/CSV ఎగుమతి.",
      intro: "ప్రతి నెల — ఎవరు తక్కువ చెల్లించారు మరియు ఏ చెల్లింపు పెండింగ్‌లో ఉందో తనిఖీ చేయండి.",
      steps: ["CSV అప్‌లోడ్ చేయండి", "ప్రతి వరుసకు UPI మొత్తం జోడించండి", "PDF/CSV ఎగుమతి చేయండి"],
      faqs: [{ question: "డేటా సర్వర్‌కు వెళ్తుందా?", answer: "లేదు. అన్నీ బ్రౌజర్‌లోనే ఉంటాయి." }]
    },
    mr: {
      name: "UPI जुळवणी साधन",
      title: "UPI जुळवणी — इनव्हॉइस आणि UTR | मोफत",
      description: "सेल्स CSV अपलोड करा, UPI रक्कम टाका आणि फरक त्वरित पहा. PDF/CSV एक्सपोर्टसह.",
      intro: "दर महिन्याला कोणी कमी भरले व कोणते पेमेंट बाकी आहे ते तपासा.",
      steps: ["CSV अपलोड करा", "प्रत्येक ओळीत UPI रक्कम भरा", "PDF/CSV एक्सपोर्ट करा"],
      faqs: [{ question: "डेटा सर्व्हरवर जातो का?", answer: "नाही. सर्व काही ब्राउझरमध्ये राहते." }]
    }
  }),
  tool("msme-receivables", "MSME Receivables Tracker", "msmeReceivables", {
    hi: {
      name: "MSME रिसीवेबल ट्रैकर",
      title: "MSME बकाया बिल ट्रैकर — 19.5% ब्याज | मुफ्त",
      description: "लंबित बिलों की उम्र, 45-दिन की देयता, और Section 16 डिमांड लेटर — सब ब्राउज़र में, कुछ अपलोड नहीं।",
      intro: "बड़े खरीदारों के बकाया बिलों को उम्र के हिसाब से बकेट करें, 19.5% ब्याज जोड़ें और कानूनी डिमांड लेटर बनाएं।",
      steps: ["अपना Udyam नंबर भरें", "बिल एंट्री करें (खरीदार, तारीख, रकम)", "डिमांड लेटर कॉपी/PDF करें"],
      faqs: [
        { question: "क्या मैं डिमांड लेटर सीधे MSE काउंसिल में फाइल कर सकता हूं?", answer: "हां। Section 16 के तहत यह प्री-लिटिगेशन नोटिस है। न चुकाने पर SAMADHAAN पोर्टल पर शिकायत करें।" },
        { question: "डेटा कहां रहता है?", answer: "केवल ब्राउज़र के localStorage में। कुछ भी सर्वर पर नहीं जाता।" }
      ]
    },
    ta: {
      name: "MSME பெறத்தக்கவை கருவி",
      title: "MSME பெறத்தக்கவை — வயதாகும், 19.5% | இலவசம்",
      description: "நிலுவை இன்வாய்ஸ்களை வயதின் படி வரிசைப்படுத்தி, Section 16 கோரிக்கை கடிதம் தயாரிக்கவும். எல்லாம் உலாவியில்.",
      intro: "கார்ப்பரேட் வாங்குபவர்களிடம் நிலுவையில் உள்ள தொகையை கண்காணிக்கவும்.",
      steps: ["Udyam எண் சேர்க்கவும்", "இன்வாய்ஸ்களை உள்ளிடவும்", "கோரிக்கை கடிதத்தை நகல்/PDF செய்யவும்"],
      faqs: [{ question: "MSE கவுன்சிலில் நேரடியாக தாக்கல் செய்யலாமா?", answer: "ஆம். இது Section 16 படி முன் வழக்கு அறிவிப்பு. SAMADHAAN இல் புகார் செய்யவும்." }]
    },
    te: {
      name: "MSME రాబడుల ట్రాకర్",
      title: "MSME రాబడులు — వయసు, 19.5% | ఉచితం",
      description: "నిల్వ ఇన్వాయిస్‌లను వయసు ప్రకారం వర్గీకరించి, Section 16 డిమాండ్ లేఖను రూపొందించండి. అన్నీ బ్రౌజర్‌లోనే.",
      intro: "కార్పొరేట్ కొనుగోలుదారుల నుండి నిల్వ చెల్లింపులను ట్రాక్ చేయండి.",
      steps: ["Udyam నంబర్ నమోదు చేయండి", "ఇన్వాయిస్‌లను నమోదు చేయండి", "డిమాండ్ లేఖ కాపీ/PDF"],
      faqs: [{ question: "MSE కౌన్సిల్‌లో నేరుగా దాఖలు చేయవచ్చా?", answer: "అవును. ఇది Section 16 కింద ముందస్తు నోటీసు. SAMADHAAN లో ఫిర్యాదు చేయండి." }]
    },
    mr: {
      name: "MSME प्राप्ती ट्रॅकर",
      title: "MSME प्राप्ती — वय, 19.5% | मोफत",
      description: "न भरलेली बिलं वयानुसार विभागून Section 16 मागणी पत्र तयार करा. सर्व ब्राउझरमध्ये.",
      intro: "कॉर्पोरेट खरेदीदारांकडील न भरलेली रक्कम ट्रॅक करा.",
      steps: ["Udyam क्रमांक भरा", "बिलं नोंदवा", "मागणी पत्र कॉपी/PDF"],
      faqs: [{ question: "MSE परिषदेत थेट दाखल करू शकतो का?", answer: "होय. Section 16 अंतर्गत हे प्री-लिटिगेशन नोटीस आहे. SAMADHAAN वर तक्रार करा." }]
    }
  }),
  tool("influencer-contract-generator", "Influencer Contract Generator", "influencerContract", {
    hi: {
      name: "इन्फ्लुएंसर अनुबंध जनरेटर",
      title: "इन्फ्लुएंसर अनुबंध जनरेटर — ब्रांड और क्रिएटर एग्रीमेंट",
      description: "ब्रांड्स और क्रिएटर्स के लिए कानूनी इन्फ्लुएंसर अनुबंध PDF बनाएं। ASCI नियम, डिलीवरी शेड्यूल, उपयोग अधिकार और UPI QR शामिल। 100% सुरक्षित।",
      intro: "ब्रांड्स और सोशल मीडिया क्रिएटर्स के बीच पारदर्शी अनुबंध बनाएं। डिलीवरेबल्स, कमर्शियल रेट्स और ASCI गाइडलाइन्स सुरक्षित करें।",
      steps: ["ब्रांड और क्रिएटर की जानकारी भरें", "प्लेटफ़ॉर्म और डिलीवरेबल (Reels, Stories) जोड़ें", "एडवांस UPI QR के साथ कानूनी PDF डाउनलोड करें"],
      faqs: [
        { question: "क्या ASCI डिस्क्लोज़र लिखना अनिवार्य है?", answer: "हाँ, भारतीय उपभोक्ता संरक्षण कानून और ASCI के तहत प्रायोजित सामग्री पर #ad या Collab लिखना आवश्यक है।" },
        { question: "क्या मेरा कॉन्ट्रैक्ट डेटा सर्वर पर सेव होता है?", answer: "बिल्कुल नहीं। यह टूल पूरी तरह आपके ब्राउज़र में चलता है और डेटा लोकल रहता है।" }
      ]
    },
    ta: {
      name: "இன்ஃப்ளூயன்சர் ஒப்பந்த ஜெனரேட்டர்",
      title: "இன்ஃப்ளூயன்சர் ஒப்பந்த ஜெனரேட்டர் | இலவச PDF",
      description: "பிராண்டுகள் மற்றும் கிரியேட்டர்களுக்கான சட்டப்பூர்வ ஒப்பந்த PDF-ஐ உருவாக்குங்கள். டெலிவரிகள், பயன்பாட்டு உரிமை மற்றும் UPI QR வசதி.",
      intro: "பிராண்டுகள் மற்றும் உள்ளடக்க படைப்பாளர்களுக்கு இடையிலான முறையான வணிக ஒப்பந்தத்தை நிமிடங்களில் தயார் செய்யுங்கள்.",
      steps: ["பிராண்ட் மற்றும் கிரியேட்டர் விவரங்களை உள்ளிடவும்", "டெலிவரி அட்டவணை மற்றும் கட்டணத்தை சேர்க்கவும்", "UPI QR உடன் PDF பதிவிறக்கவும்"],
      faqs: [
        { question: "ASCI வழிகாட்டுதல் அவசியமா?", answer: "ஆம், விளம்பர விதிகளின்படி ஸ்பான்சர் செய்யப்பட்ட பதிவுகளுக்கு வெளிப்படைத்தன்மை தேவை." },
        { question: "தரவு சேமிக்கப்படுகிறதா?", answer: "இல்லை, அனைத்தும் உங்கள் உலாவியிலேயே தனிப்பட்ட முறையில் இயங்கும்." }
      ]
    },
    te: {
      name: "ఇన్‌ఫ్లూయెన్సర్ కాంట్రాక్ట్ జనరేటర్",
      title: "ఇన్‌ఫ్లూయెన్సర్ కాంట్రాక్ట్ జనరేటర్ | ఉచిత లీగల్ PDF",
      description: "బ్రాండ్‌లు మరియు క్రియేటర్ల కోసం చట్టబద్ధమైన ఇన్‌ఫ్లూయెన్సర్ అగ్రిమెంట్ PDF సృష్టించండి. డెలివరీలు, హక్కులు మరియు UPI QRతో ఉచితం.",
      intro: "బ్రాండ్‌లు మరియు క్రియేటర్‌ల మధ్య పారదర్శక ఒప్పందాన్ని సులభంగా తయారు చేయండి. డెలివరీలు మరియు చెల్లింపు నిబంధనలను పొందుపరచండి.",
      steps: ["బ్రాండ్ మరియు క్రియేటర్ వివరాలను నమోదు చేయండి", "డెలివరీల వివరాలు మరియు ధరలను జోడించండి", "UPI QRతో చట్టబద్ధమైన PDF డౌన్‌లోడ్ చేసుకోండి"],
      faqs: [
        { question: "ASCI నిబంధనలు తప్పనిసరియా?", answer: "అవును, ప్రాయోజిత పోస్టులకు స్పష్టమైన ప్రకటన వెల్లడి అవసరం." },
        { question: "డేటా సర్వర్‌కు పంపబడుతుందా?", answer: "లేదు, మొత్తం సమాచారం మీ బ్రౌజర్‌లోనే భద్రంగా ఉంటుంది." }
      ]
    },
    mr: {
      name: "इन्फ्लुएन्सर करार जनरेटर",
      title: "इन्फ्लुएन्सर करार जनरेटर — ब्रँड आणि क्रिएटर अ‍ॅग्रीमेंट",
      description: "ब्रँड्स आणि क्रिएटर्ससाठी कायदेशीर इन्फ्लुएन्सर करार PDF तयार करा. ASCI नियम, वितरण वेळापत्रक, हक्क आणि UPI QR समाविष्ट. १००% मोफत.",
      intro: "ब्रँड्स आणि सोशल मीडिया क्रिएटर्ससाठी सुरक्षित आणि पारदर्शक करार तयार करा. व्यावसायिक अटी आणि मानधन स्पष्ट करा.",
      steps: ["ब्रँड व क्रिएटरचे नाव आणि तपशील भरा", "डिलिव्हरेबल्स (Reels, Posts) आणि फी जोडा", "UPI QR सह कायदेशीर PDF डाउनलोड करा"],
      faqs: [
        { question: "ASCI नियम पाळणे आवश्यक आहे का?", answer: "होय, प्रायोजित जाहिरातींवर स्पष्ट खुलासे देणे कायद्यानुसार बंधनकारक आहे." },
        { question: "माझा डेटा सुरक्षित आहे का?", answer: "होय, हा टूल पूर्णपणे ब्राउझरमध्ये चालतो आणि सर्व माहिती तुमच्या डिव्हाइसवरच राहते." }
      ]
    }
  }),
  tool("freelance-contract-generator", "Freelance Contract Generator", "freelanceContract", {
    hi: {
      name: "फ्रीलांस अनुबंध जनरेटर",
      title: "फ्रीलांस अनुबंध जनरेटर — सर्विस एग्रीमेंट और SOW",
      description: "फ्रीलांसर्स के लिए कानूनी सर्विस एग्रीमेंट PDF बनाएं। माइलस्टोन भुगतान, संशोधन सीमा, IP अधिकार और एडवांस UPI QR शामिल। 100% प्राइवेट।",
      intro: "क्लाइंट के साथ काम शुरू करने से पहले स्पष्ट शर्तें तय करें। माइलस्टोन, संशोधन सीमा और IP ट्रांसफर की शर्तें कानूनी रूप से सुरक्षित करें।",
      steps: ["क्लाइंट और अपनी व्यावसायिक जानकारी दर्ज करें", "प्रोजेक्ट माइलस्टोन, डिलीवरी तिथि और राशि जोड़ें", "एडवांस UPI QR के साथ सर्विस एग्रीमेंट PDF बनाएं"],
      faqs: [
        { question: "बौद्धिक संपदा (IP) क्लाइंट को कब ट्रांसफर होती है?", answer: "इस एग्रीमेंट के तहत पूरा और अंतिम भुगतान प्राप्त होने के बाद ही IP ट्रांसफर मान्य होती है।" },
        { question: "क्या संशोधन की सीमा तय करना जरूरी है?", answer: "हाँ, अनपेक्षित एक्स्ट्रा काम (Scope Creep) से बचने के लिए प्रति माइलस्टोन 2 राउंड संशोधन तय किए गए हैं।" }
      ]
    },
    ta: {
      name: "ஃப்ரீலான்ஸ் ஒப்பந்த ஜெனரேட்டர்",
      title: "ஃப்ரீலான்ஸ் ஒப்பந்த ஜெனரேட்டர் | இலவச PDF",
      description: "ஃப்ரீலான்சர்களுக்கான முறையான சேவை ஒப்பந்த PDF-ஐ உருவாக்குங்கள். மைல்ஸ்டோன் பணம், திருத்த வரம்புகள் மற்றும் UPI QR உடனடி தயாரிப்பு.",
      intro: "கிளையண்டுகளுடன் தெளிவான விதிமுறைகளை அமைத்து நிலுவைப் பணம் மற்றும் வரம்பற்ற திருத்தங்களிலிருந்து உங்கள் பணியைப் பாதுகாத்துக் கொள்ளுங்கள்.",
      steps: ["கிளையண்ட் மற்றும் உங்களது விவரங்களை உள்ளிடவும்", "திட்டப் பணிகள் மற்றும் கட்டண விவரங்களை சேர்க்கவும்", "UPI QR உடன் PDF-ஐ உடனடியாக பதிவிறக்கவும்"],
      faqs: [
        { question: "முழு கட்டணம் செலுத்தும் வரை IP யாரிடம் இருக்கும்?", answer: "முழு கட்டணமும் செலுத்திய பின்னரே படைப்புரிமை கிளையண்டுக்கு மாற்றப்படும்." },
        { question: "திருத்த வரம்புகள் உள்ளதா?", answer: "ஆம், கூடுதல் கட்டணமின்றி அதிகபட்சம் 2 திருத்தங்கள் மட்டுமே அனுமதிக்கப்படும்." }
      ]
    },
    te: {
      name: "ఫ్రీలాన్స్ కాంట్రాక్ట్ జనరేటర్",
      title: "ఫ్రీలాన్స్ కాంట్రాక్ట్ జనరేటర్ | ఉచిత లీగల్ PDF",
      description: "ఫ్రీలాన్సర్ల కోసం ప్రొఫెషనల్ సర్వీస్ కాంట్రాక్ట్ PDF సృష్టించండి. మైల్‌స్టోన్ చెల్లింపులు, రివిజన్ పరిమితులు మరియు UPI QRతో ఉచితం.",
      intro: "క్లయింట్‌లతో పని ప్రారంభించే ముందే స్పష్టమైన నిబంధనలను రూపొందించండి. సకాలంలో చెల్లింపులు మరియు IP హక్కులను కాపాడుకోండి.",
      steps: ["క్లయింట్ మరియు ఫ్రీలాన్సర్ వివరాలను నమోదు చేయండి", "ప్రాజెక్ట్ మైల్‌స్టోన్‌లు మరియు గడువులను జోడించండి", "UPI QRతో ఒప్పంద పత్రాన్ని PDF రూపంలో పొందండి"],
      faqs: [
        { question: "IP హక్కులు క్లయింట్‌కు ఎప్పుడు బదిలీ అవుతాయి?", answer: "పూర్తి మరియు తుది చెల్లింపు పూర్తయిన తర్వాత మాత్రమే హక్కులు బదిలీ చేయబడతాయి." },
        { question: "సవరణలకు పరిమితి ఉంటుందా?", answer: "అవును, అదనపు శ్రమను నివారించడానికి ప్రతి మైల్‌స్టోన్‌కు 2 సవరణల రౌండ్లు నిర్దేశించబడ్డాయి." }
      ]
    },
    mr: {
      name: "फ्रीलान्स करार जनरेटर",
      title: "फ्रीलान्स करार जनरेटर — सर्व्हिस अ‍ॅग्रीमेंट व SOW",
      description: "फ्रीलान्सर्ससाठी कायदेशीर सेवा करार PDF तयार करा. टप्प्याटप्प्याने पेमेंट, रिव्हिजन मर्यादा, IP मालकी आणि UPI QR समाविष्ट. मोफत व सुरक्षित.",
      intro: "ग्राहकांसोबत स्पष्ट व्यावसायिक अटी ठरवा. पेमेंटच्या विलंबापासून आणि अमर्याद बदलांपासून स्वतःचे रक्षण करा.",
      steps: ["क्लायंट आणि तुमचे व्यावसायिक तपशील भरा", "प्रकल्प टप्पे, देय तारीख आणि मानधन नोंदवा", "UPI QR सह कायदेशीर सेवा करार PDF डाउनलोड करा"],
      faqs: [
        { question: "कामाची बौद्धिक मालकी (IP) कधी हस्तांतरित होते?", answer: "संपूर्ण अंतिम पेमेंट मिळाल्यानंतरच सर्व बौद्धिक संपदा अधिकार क्लायंटकडे जातात." },
